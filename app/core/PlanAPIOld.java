...
/**
 * Created by zephyre on 7/18/14.
 */
public class PlanAPIOld {
    public static JsonNode getPlanJsonOld(DBObject item) throws TravelPiException {
...
//            builder.add(k, (tmp == null || !(tmp instanceof Integer)) ? "" : (int) tmp);
    ...
    public static DBObject getPlanOld(String planId) throws TravelPiException {
        DBCollection col = Utils.getMongoClient().getDB("plan").getCollection("plan_info");
        try {
            if (planId == null)
