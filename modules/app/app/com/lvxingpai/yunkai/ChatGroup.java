...
public class ChatGroup implements org.apache.thrift.TBase<ChatGroup, ChatGroup._Fields>, java.io.Serializable, Cloneable, Comparable<ChatGroup> {
  ...
  public ChatGroup setChatGroupId(long chatGroupId) {
    this.chatGroupId = chatGroupId;
    setChatGroupIdIsSet(true);
    return this;
  }
  ...
  public ChatGroup setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public ChatGroup setGroupDesc(String groupDesc) {
  ...
  public ChatGroup setAvatar(String avatar) {
    this.avatar = avatar;
    return this;
  }
  ...
  public ChatGroup setTags(List<String> tags) {
    this.tags = tags;
    return this;
  }
  ...
  public ChatGroup setCreator(long creator) {
    this.creator = creator;
    setCreatorIsSet(true);
    return this;
  }
  ...
  public ChatGroup setAdmin(List<Long> admin) {
    this.admin = admin;
    return this;
  }
  ...
  public ChatGroup setParticipants(List<Long> participants) {
    this.participants = participants;
    return this;
  }
  ...
  public ChatGroup setMaxUsers(int maxUsers) {
    this.maxUsers = maxUsers;
    setMaxUsersIsSet(true);
    return this;
  }
  ...
  public ChatGroup setCreateTime(long createTime) {
    this.createTime = createTime;
    setCreateTimeIsSet(true);
    return this;
  }
  ...
  public ChatGroup setUpdateTime(long updateTime) {
    this.updateTime = updateTime;
    setUpdateTimeIsSet(true);
    return this;
  }
  ...
  public ChatGroup setVisible(boolean visible) {
    this.visible = visible;
    setVisibleIsSet(true);
    return this;
  }
