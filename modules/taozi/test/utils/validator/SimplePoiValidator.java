 ...
 */
public class SimplePoiValidator implements AbstractValidator {
    ...
    public void validate(JsonNode item) {
        ...
        fields.addAll(Arrays.asList("id", "zhName", "enName", "rating", "address", "images", "type", "timeCostDesc",
                "priceDesc", "rank", "location"));
        ...
        assertText(item, true, "enName", "address", "timeCostDesc", "priceDesc");
