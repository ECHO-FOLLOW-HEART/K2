    ...
    public JsonNode format(TravelPiBaseItem item) {
        ...
        PropertyFilter theFilter = new SimpleBeanPropertyFilter() {
            ...
            private boolean includeImpl(PropertyWriter writer) {
                ...
                Collections.addAll(includedFields, Destination.fnId,Destination.fnZhName,Destination.fnEnName,Destination.fnDesc,
                        Destination.fnAlias,Destination.fnCountry,Destination.fnImage,Destination.fnTravelMonth,Destination.fnTimeCostDesc,
                        Destination.fnLocalities);
