 ...
 */
public class DetailedPOIFormatterOld<T extends AbstractPOI> extends TaoziBaseFormatter {
    ...
    public DetailedPOIFormatterOld setImageWidth(int width) {
        imageWidth = width;
        return this;
    }

    public DetailedPOIFormatterOld(Class<T> poiClass) {
...
//                AbstractPOI.FD_TAOZIENA
        ...
        if (DetailedPOIFormatterOld.this.getPoiClass() == ViewSpot.class) {
