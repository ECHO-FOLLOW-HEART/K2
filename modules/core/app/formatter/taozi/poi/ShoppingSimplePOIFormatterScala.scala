 ...
 * Created by pengyt on 2015/8/31.
 */
class ShoppingSimplePOIFormatterScala extends BaseFormatter {
  ...
  override val objectMapper = {
    ...
    module.addSerializer(classOf[Shopping], new ShoppingPOISerializerScala)
...
object ShoppingSimplePOIFormatterScala {

  def apply(width: Int): ShoppingSimplePOIFormatterScala = {
    val result = new ShoppingSimplePOIFormatterScala
    result.width = width
    result
  }
}