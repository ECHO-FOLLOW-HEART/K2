    ...
    public JsonNode format(TravelPiBaseItem item, final String guidePart) {
        ...
        PropertyFilter guideFilter = new SimpleBeanPropertyFilter() {
            ...
            private boolean includeImpl(PropertyWriter writer) {
                ...
                if (guidePart.equals(AbstractGuide.fnShopping)) {
                    includedFields.add(DestGuideInfo.fnShoppingImages);
                    includedFields.add(DestGuideInfo.fnShoppingDesc);
                } else if (guidePart.equals(AbstractGuide.fnRestaurant)) {
                    includedFields.add(DestGuideInfo.fnRestaurantImages);
                    includedFields.add(DestGuideInfo.fnRestaurantDesc);
                }
        ...
        FilterProvider filters = new SimpleFilterProvider().addFilter("destGuideInfoFilter", guideFilter).addFilter("imageItemPOIFilter", imgFilter);
