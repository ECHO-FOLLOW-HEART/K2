 ...
 */
public class GuideTemplateFormatter extends AizouFormatter<GuideTemplate> {

    public GuideTemplateFormatter(Integer imgWidth) {
        registerSerializer(GuideTemplate.class, new GuideTemplateSerializer());
    ...
    private class GuideTemplateSerializer extends AizouSerializer<GuideTemplate> {
        @Override
        public void serialize(GuideTemplate guide, JsonGenerator jgen, SerializerProvider serializerProvider)
                throws IOException {
