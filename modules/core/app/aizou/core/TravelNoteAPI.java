...
//    }
    ...
    public static List<TravelNote> searchNoteByPlan(ObjectId planId, int page, int pageSize) throws AizouException, SolrServerException {
...
//            sb.append(t + " ");
        ...
        return searchNotesByWord(sb.toString(), page, pageSize);
    }
    ...
    public static List<TravelNote> searchNotesByWord(String keyword, int page, int pageSize) throws SolrServerException, AizouException {
        ...
        //进行查询，获取游记文档
        SolrServer server = getSolrConnect();
        SolrQuery query = new SolrQuery();
