...
public class TravelNoteAPI {
     ...
     */
    public static List<TravelNote> getTravelNote(List<String> locNames, List<String> vsNames, int pageSize) throws TravelPiException, SolrServerException, ParseException {
