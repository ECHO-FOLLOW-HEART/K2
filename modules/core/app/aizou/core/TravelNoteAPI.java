...
//                    String shortName = LocalityAPI.getLocality(item.loc.id).shortName;
     ...
     * @throws ParseException
     */
    public static List<TravelNote> getTravelNote(List<String> locNames, List<String> vsNames, int pageSize) throws AizouException, SolrServerException, ParseException {
