...
//                value = UserUgcAPI.strListToObjectIdList((Iterator<JsonNode>) value, Locality.class);
//            else if (key.equals(UserInfo.fnTravelNotes))
//                value = UserUgcAPI.strListToObjectIdList((Iterator<JsonNode>) value, TravelNote.class);
            ops.set(key, value);
        }
